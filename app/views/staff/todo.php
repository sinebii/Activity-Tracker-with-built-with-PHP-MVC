    ...
    <div class="topbar-menu">
        ...
        <div class="sidebar">
            ...
            <div class="sidebar-menu">
                ...
                if($data['access']->access ==2 || $data['access']->access ==1){
        ...
        <div class="todo-container">
            ...
            <div class="todo-form-container">
                ...
                <form id="todoForm">
                    ...
                    <input type="submit" id="todoBtn"value="Add Task">
                </form>


            </div>
            
            <div class="todo-header"><i class="fa fa-align-justify"></i> Task list</div>
            <div class="todo-list">
